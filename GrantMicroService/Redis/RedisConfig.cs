...
namespace GrantMicroService.Redis
{
    public class RedisConfig
    {
        ...
        public static void Initlize(Config.RedisConfig config)
        {
            ...
            {
                logger.LogError(ex, "GrantMicroService.Redis.redisConfig.Initlize error");
                throw ex;
            }
            finally
            {
        ...
        public static RedisNode GetNode(string nodeName)
        {
            try
            {
                ...
                logger.LogCritical($"GrantMicroService.Redis.redisConfig.GetNode nodeName={nodeName} is not exist");
            }
            catch (Exception ex)
            {
                logger.LogCritical(ex, $"GrantMicroService.Redis.redisConfig.GetNode error nodeName={nodeName}");
            }
            finally
            {
