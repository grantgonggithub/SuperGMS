...
////            proxy = (ServerProxy)app.CreateInstanceFromAndUnwrap(path.TrimEnd("\\".ToCharArray()) + "\\" + "GrantMicroService.dll",
...
//                {
//                    if (c.ServerName.ToLower() == GrantMicroService.RpcProxy.GrantHAWorkerRpcProxy.serviceName.ToLower())
...
//                apps.Values.ToArray()[0].v1.ServerName.ToLower() == GrantMicroService.RpcProxy.GrantHAWorkerRpcProxy.serviceName.ToLower())
//                return;
//            try
//            {
//                if (apps != null && apps.Count > 0)
