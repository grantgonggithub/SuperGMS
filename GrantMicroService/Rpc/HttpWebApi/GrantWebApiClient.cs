/*----------------------------------------------------------------
 ...
 项目名称： GrantMicroService.Rpc.HttpWebApi
...
namespace GrantMicroService.Rpc.HttpWebApi
{
    /// <summary>
    /// GrantWebApiClient
    /// </summary>
    public class GrantWebApiClient : IGrantRpcClient
    {
        ...
        public GrantWebApiClient(ClientItem server)
        {
            clientItem = server;
        }
