/*----------------------------------------------------------------
 ...
 项目名称：GrantMicroService.Thrift.Server
 文件名：GrantServer
...
using GrantMicroService.Zookeeper;
...
namespace GrantMicroService.Rpc
{
    ...
    /// </summary>
    public abstract class GrantBaseServer : IGrantRpcServer
    {
        /// <summary>
        /// 服务发送, distributer 把收到的信息转发给Thrift
        /// </summary>
        private GrantRpcDistributer distributer;
        protected readonly static ILogger logger = LogFactory.CreateLogger<GrantBaseServer>();
        /// <summary>
        /// 注册服务
        /// </summary>
        ...
        /// </summary>
        /// <param name="server">服务配置</param>
        protected abstract void ServerRegister(GrantServerConfig server);
