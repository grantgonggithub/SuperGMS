/*----------------------------------------------------------------
 ...
 项目名称：GrantMicroService.DB.EFEx.GrantDbContext
...
namespace GrantMicroService.DB.EFEx
{
    ...
    /// </summary>
    public class GrantDapperDBContext : IGrantDapperDbContext
    {
        ...
        private void SqlRepositoryManager_OnDbCommit(GrantDBConnection GrantDBConnection, SqlPara auditSql)
        {
