...
namespace SuperGMS.Tools
{
    ...
    public class HttpHelper
    {
        ...
        /// <returns></returns>
        public string URLDecode(string text, Encoding encoding = null)
        {
            return System.Web.HttpUtility.UrlDecode(text, encoding ?? Encoding.UTF8);
        }
        ...
        /// <returns></returns>
        public string URLEncode(string text, Encoding encoding = null)
        {
            return System.Web.HttpUtility.UrlEncode(text, encoding ?? Encoding.UTF8);
        }
